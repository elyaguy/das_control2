window.angularApp.controller("ReportPurchaseSupplierWiseComparativeController", [
    "$scope",
    "API_URL",
    "window",
    "jQuery",
    ...
    function (
        ...
        dt.dataTable({
            ...
            "dom": 'lfBrtip',
            "serverSide": true,
            "ajax": API_URL + "/_inc/report_purchase_supplierwise_comparative.php?from=" + $from + "&to=" + $to,
            "fixedHeader": true,
            "aLengthMenu": [
                [10, 25, 50, 100, 200, -1],

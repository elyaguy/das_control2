window.angularApp.factory("PurchaseReturnAllViewModal", ["API_URL", "window", "jQuery", "$http", "$uibModal", "$sce", "$rootScope", function (API_URL, window, $, $http, $uibModal, $sce, $scope) {
    return function (data) {
        var uibModalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance) {
                $http({
                  url: window.baseUrl + "/_inc/purchase_return_all.php?invoice_id=" + data.invoice_id + '&action_type=VIEW',
                  method: "GET"
                })

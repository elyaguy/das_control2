window.angularApp.factory("PurchaseReturnAllEditModal", ["API_URL", "window", "jQuery", "$http", "$uibModal", "$sce", "$rootScope", function (API_URL, window, $, $http, $uibModal, $sce, $scope) {
    return function(transfer) {
        ...
        var uibModalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance) {
                $http({
                  url: API_URL + "/_inc/purchase_return_all.php?id=" + transfer.id + "&action_type=EDIT",
                  method: "GET"
                })

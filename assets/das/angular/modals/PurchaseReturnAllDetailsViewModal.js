window.angularApp.factory("PurchaseReturnAllDetailsViewModal", ["API_URL", "window", "jQuery", "$http", "$uibModal", "$sce", "$rootScope", function (API_URL, window, $, $http, $uibModal, $sce, $scope) {
    return function (transfer) {
        var uibModalInstance = $uibModal.open({
            ...
            controller: function ($scope, $uibModalInstance) {
                $http({
                  url: window.baseUrl + "/_inc/purchase_return_all.php?transfer_id=" + transfer.id + '&action_type=VIEW',
                  method: "GET"
                })

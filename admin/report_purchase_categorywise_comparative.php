...
if (user_group_id() != 1 && !has_permission('access', 'read_comparative_report')) {
...
// Add Script
$document->addScript('../assets/das/angular/controllers/ReportPurchaseCategoryWiseComparativeController.js');
...
<div class="content-wrapper" ng-controller="ReportPurchaseCategoryWiseComparativeController">

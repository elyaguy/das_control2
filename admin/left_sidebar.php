<aside class="main-sidebar">
  <section class="sidebar">
    ...
    -->
      ...
      <?php if (
        user_group_id() == 1 || has_permission('access', 'read_purchase_list')
        || has_permission('access', 'create_purchase_invoice')
        || has_permission('access', 'read_purchase_return')
        || has_permission('access', 'read_purchase_log')
      ) : ?>
      ...
      <?php if (
        user_group_id() == 1 || has_permission('access', 'deposit')
        || has_permission('access', 'withdraw') || has_permission('access', 'transfer')
        || has_permission('access', 'read_bank_transfer') || has_permission('access', 'read_bank_transactions')
        || has_permission('access', 'read_bank_account') || has_permission('access', 'create_bank_account')
        || has_permission('access', 'read_bank_account_sheet') || has_permission('access', 'read_income_monthwise')
        || has_permission('access', 'read_expense_monthwise') || has_permission('access', 'read_income_and_expense_report')
      ...
      <?php if (
        user_group_id() == 1 || has_permission('access', 'read_expense')
        || has_permission('access', 'create_expense') || has_permission('access', 'read_expense_category')
      ...
      <?php if (
        user_group_id() == 1 || has_permission('access', 'read_store') || has_permission('access', 'receipt_template') || has_permission('access', 'read_user_preference')
        || has_permission('access', 'read_unit') || has_permission('access', 'read_taxrate') || has_permission('access', 'read_pmethod') || has_permission('access', 'read_currency') || has_permission('access', 'read_brand')
        || has_permission('access', 'read_box') || has_permission('access', 'read_printer') || has_permission('access', 'read_college') || has_permission('access', 'read_course')
        || has_permission('access', 'sms_setting') || has_permission('access', 'backup') || has_permission('access', 'language_translation')
      ) : ?>
        ...
        <li class="treeview<?php echo current_nav() == 'store' || current_nav() == 'receipt_template' || current_nav() == 'store_create' || current_nav() == 'user_preference' || current_nav() == 'store_single' || current_nav() == 'brand' || current_nav() == 'currency' || current_nav() == 'pmethod' || current_nav() == 'unit' || current_nav() == 'taxrate' || current_nav() == 'box' || current_nav() == 'printer' || current_nav() == 'sms_setting' || current_nav() == 'backup_restore' || current_nav() == 'language' ? ' active' : null; ?>">
          ...
          <ul class="treeview-menu">
            ...
            <?php if (user_group_id() == 1 || has_permission('access', 'read_college') || has_permission('access', 'read_course')) : ?>
              <li class="treeview<?php echo current_nav() == 'college' || current_nav() == 'college_profile' ? ' active' : null; ?>">
                <a href="college.php">
                  <svg class="svg-icon">
                    <use href="#icon-list">
                  </svg>
                  <span>
                    <?php echo trans('menu_college'); ?>
                  </span>
                  <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                  <?php if (user_group_id() == 1 || has_permission('access', 'create_college')) : ?>
                    <li class="<?php echo current_nav() == 'college' && isset($request->get['box_state']) ? ' active' : null; ?>">
                      <a href="college.php?box_state=open">
                        <svg class="svg-icon">
                          <use href="#icon-plus">
                        </svg>
                        <span>
                          <?php echo trans('menu_add_college'); ?>
                        </span>
                      </a>
                    </li>
                  <?php endif; ?>
                  <?php if (user_group_id() == 1 || has_permission('access', 'read_college')) : ?>
                    <li class="<?php echo current_nav() == 'college'  && !isset($request->get['box_state']) ? ' active' : null; ?>">
                      <a href="college.php">
                        <svg class="svg-icon">
                          <use href="#icon-list">
                        ...
                        <span>
                          <?php echo trans('menu_college_list'); ?>
                        </span>
                      </a>
                    </li>
                  <?php endif; ?>

                  <?php if (user_group_id() == 1 || has_permission('access', 'create_course')) : ?>
                    <li class="<?php echo current_nav() == 'course' && isset($request->get['box_state']) ? ' active' : null; ?>">
                      <a href="course.php?box_state=open">
                        <svg class="svg-icon">
                          <use href="#icon-plus">
                        </svg>
                        <span>
                          <?php echo trans('menu_add_course'); ?>
                        </span>
                      </a>
                    </li>
                  <?php endif; ?>
                  <?php if (user_group_id() == 1 || has_permission('access', 'read_course')) : ?>
                    <li class="<?php echo current_nav() == 'course'  && !isset($request->get['box_state']) ? ' active' : null; ?>">
                      <a href="course.php">
                        <svg class="svg-icon">
                          <use href="#icon-list">
                        ...
                        <span>
                          <?php echo trans('menu_course_list'); ?>
                        </span>
                      </a>
                    </li>
                  <?php endif; ?>

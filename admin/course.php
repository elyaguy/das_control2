...
<div class="content-wrapper" ng-controller="CourseController">
  ...
  <section class="content-header">
    <h1>
      <?php echo trans('text_course_title'); ?>
      <small>
        <?php echo store('name'); ?>
      </small>
    </h1>
  ...
  <section class="content">
    ...
    <div class="box box-info<?php echo create_box_state(); ?>">
      <div class="box-header with-border">
        <h3 class="box-title">
          <span class="fa fa-fw fa-plus"></span> <?php echo trans('text_new_course_title'); ?>
        </h3>
      ...
      <?php include('../_inc/template/course_create_form.php'); ?>
      ...
      <div class="col-xs-12">
        <div class="box box-success">
          <div class="box-header">
            <h3 class="box-title">
              <?php echo trans('text_course_list_title'); ?>
            </h3>
          </div>
          <div class="box-body">
            <div class="table-responsive"> 
              <?php
                $hide_colums = "";
                if (user_group_id() != 1) {
                  if (!has_permission('access', 'read_course_profile')) {
                    $hide_colums .= "4,";
                  }
                  if (!has_permission('access', 'update_course')) {
                    $hide_colums .= "5,";
                  }
                  if (!has_permission('access', 'delete_course')) {
                    $hide_colums .= "6,";
                  }
                }
              ?>   
              <table id="course-course-list" class="table table-bordered table-striped table-hover" data-hide-colums="<?php echo $hide_colums; ?>" >
                <thead>
                  <tr class="bg-gray">
                    <th class="w-5">

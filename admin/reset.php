	...
	<div class="container">
		<div class="container-inner">
			<?php if (!empty($errors)):?>
				...
				<?php endforeach;?>				
			<?php endif;?>
			<h2 class="title">RESTABLECIMIENTO DE DATOS <br><?php echo store('name');?></h2>
			<h4 class="text">Vas a restablecer tu DAS CONTROL. Esta acción eliminará todos los datos que no se puedan restaurar de nuevo. Si continúa con esta acción, haga clic en 'Sí'; de lo contrario, haga clic en el botón 'No'.</h4>
		</div>
		<div class="store-container">
	    	<h4 class="title">SELECCIONA TIENDA</h4>

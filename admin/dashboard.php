...
<div class="content-wrapper" ng-controller="DashboardController">
  ...
  <section class="content">
            ...
            <div class="box-body">
              <?php if (settings('is_update_available')) : ?>
                <div class="alert alert-warning mb-0">
                  <p><span class="fa fa-fw fa-info-circle"></span> Version <span class="label label-info">
                      <?php echo settings('update_version'); ?>
                    </span> is available now. <a href="<?php echo settings('update_link'); ?>" target="_blink">Read
                      changelog
                      & update instructions here</a></p>
                </div>
              <?php endif; ?>
              <?php if (DEMO) : ?>
    ...
    <div class="row">
      <?php if (user_group_id() == 6 || has_permission('access', 'read_dashboard_invoce_view')) : ?>
        <div class="col-md-3 col-xs-6">
          <div id="invoice-count" class="small-box bg-green">
            <div class="inner">
              <h4>
                <i>
                  <?php echo trans('text_total_invoice_all_store'); ?>
                </i> <span class="total-invoice">
                  <?php
              ...
              <h4>
                <i>
                  <?php echo trans('text_total_invoice_today_all_store'); ?>
                </i> <span class="total-invoice">
                  <?php
      ...
      <?php endif; ?>
       ...
       <?php if (user_group_id() == 6 || has_permission('access', 'read_dashboard_customer_view')) : ?>
        <div class="col-md-3 col-xs-6">
      ...
      <!--
      <?php if (user_group_id() == 6 || has_permission('access', 'read_dashboard_supplier_view')) : ?>
        <div class="col-md-3 col-xs-6">
          <div id="supplier-count" class="small-box bg-purple">
            <div class="inner">
              <h4>
            ...
            <?php if (user_group_id() == 6 || has_permission('access', 'read_supplier')) : ?>
              <a href="supplier.php" class="small-box-footer">
                <?php echo trans('text_details'); ?>
                <i class="fa fa-arrow-circle-right"></i>
              </a>
      ...
      <?php if (user_group_id() == 6 || has_permission('access', 'read_dashboard_product_view')) : ?>
        <div class="col-md-3 col-xs-6">
          <div id="product-count" class="small-box bg-yellow">
            <div class="inner">
              <h4>
            ...
            <?php if (user_group_id() == 6 || has_permission('access', 'read_product')) : ?>
              <a href="product.php" class="small-box-footer">
                <?php echo trans('text_details'); ?>
                <i class="fa fa-arrow-circle-right"></i>
              </a>
          ...
          <div class="col-md-12">
            <div class="box box-info">
              <div class="box-header with-border">
                <h3 class="box-title">
                  <?php echo trans('text_recent_activities'); ?>
                </h3>
              </div>
              <div class="box-body">
                ...
                <div class="col-sm-6 col-xs-6">
                  <div class="description-block border-right">
                    <h2 class="description-header">
                      <?php echo currency_format(get_bank_deposit_amount(date('Y-m-d'), date('Y-m-d'))); ?>
                    </h2>
                    <h4 class="description-text">
                      <?php echo trans('text_deposit_today'); ?>
                    </h4>
                  </div>
                </div>
                <div class="col-sm-6 col-xs-6">
                  <div class="description-block border-right">
                    <h2 class="description-header">
                      <?php echo currency_format(get_bank_withdraw_amount(date('Y-m-d'), date('Y-m-d'))); ?>
                    </h2>
                    <h4 class="description-text">
                      <?php echo trans('text_withdraw_today'); ?>
                    </h4>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="pr-15 col-md-6 col-xs-12">
                  <div class="box box-default banking-box">
                    <div class="box-header with-border">
                      <h3 class="box-title">
                        <?php echo trans('text_recent_deposit'); ?>
                      </h3>
                    </div>
                    <div class="box-body">
                              ...
                              <?php foreach ($transactions as $row) : ?>
                                <tr>
                                  ...
                                  <td class="w-20 text-right">
                                    <?php echo currency_format($row['amount']); ?>
                                  </td>
                                </tr>
                              <?php endforeach; ?>
                            <?php endif; ?>
                ...
                <div class="pr-15 pl-5 col-md-6 col-xs-12">
                  <div class="box box-default banking-box">
                    <div class="box-header with-border">
                      <h3 class="box-title">
                        <?php echo trans('text_recent_withdraw'); ?>
                      </h3>
                    </div>
                    <div class="box-body">
                      <div class="table-responsive" style="min-height:150px">

                            ...
                            <?php if ($transactions = $banking_model->getTransactions('deposit', store_id(), 3)): ?>
                              <?php foreach ($transactions as $row): ?>
                                <tr>
                                  ...
                                  <td class="w-45"><a class="view-deposit" data-refno="<?php echo $row['ref_no']; ?>" href="#"
                                      tyle="white-space:nowrap;max-width:100%;overflow:hidden;display:inline-block;"><?php echo $row['title']; ?></a></td>
                            ...
                            <?php if ($transactions = $banking_model->getTransactions('withdraw', store_id(), 3)): ?>
                              <?php foreach ($transactions as $row): ?>
                                <tr>
                                  ...
                                  <td class="w-45"><a class="view-withdraw" data-refno="<?php echo $row['ref_no']; ?>"
                                      href="#"
                                      style="white-space:nowrap;max-width:100%;overflow:hidden;display:inline-block;"><?php echo $row['title']; ?></a></td>
                                  <td class="w-20 text-right">
                                    <?php echo currency_format($row['amount']); ?>
                                  </td>
                                </tr>

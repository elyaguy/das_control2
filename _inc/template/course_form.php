...
<form class="form-horizontal" id="course-form" action="course.php" method="post">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
        <button id="course-update" data-form="#course-form" data-datatable="#course-course-list" class="btn btn-info" name="btn_edit_course" data-loading-text="Actualizando Espera..!">

...
<form class="form-horizontal" id="unit-form" action="unit.php" method="post">
  ...
  <div class="box-body">
    ...
    <!-- <div class="form-group">
      ...
      <div class="col-sm-8 store-selector">
        <div class="checkbox selector">
          <label>
            <input type="checkbox" onclick="$('input[name*=\'unit_store\']').prop('checked', this.checked);"> Seleccionar / Deseleccionar
          </label>
        </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">            
        <button id="unit-update" class="btn btn-info"  data-form="#unit-form" data-datatable="#unit-unit-list" name="btn_edit_customer" data-loading-text="Actualizando Espera..!">

<form id="create-supplier-form" class="form-horizontal" action="supplier.php" method="post" enctype="multipart/form-data">
  ...
  <div class="box-body">
    ...
    <div class="form-group hidden">
        ...
        <div class="col-sm-7">
          <input type="text" class="form-control" id="code_name" value="{{ supName | strReplace:' ':'_' | lowercase }}" name="code_name">
        </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-7">
        <input type="text" class="form-control" id="sup_mobile" name="sup_mobile" value="<?php echo isset($request->post['sup_mobile']) ? $request->post['sup_mobile'] : null; ?>" >
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-7">
        <textarea class="form-control" id="sup_address"  name="sup_address" value="<?php echo isset($request->post['sup_address']) ? $request->post['sup_address'] : null; ?>" ></textarea>
      </div>
    </div>

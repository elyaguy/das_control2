...
<!-- 
    <div class="form-group">
      ...
      <div class="col-sm-6 store-selector">
        <div class="checkbox selector">
          <label>
            <input type="checkbox" onclick="$('input[name*=\'currency_store\']').prop('checked', this.checked);"> Seleccionar / Deseleccionar
          </label>
        </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
          <button id="currency-update" class="btn btn-info"  data-form="#currency-form" data-datatable="#currency-currency-list" name="btn_edit_customer" data-loading-text="Actualizando Espera..!">

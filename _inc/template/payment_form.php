...
<form class="form-horizontal" id="checkout-form" action="place_order.php">
	...
	<div class="bootbox-body">
		<div class="table-selection">
			<div class="col-lg-3 col-md-3 col-sm-3 bootboox-tab-menu bootboox-container p-0 hidden">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 checkout-payment-option bootboox-container">
				<div class="tab-wrapper tab-cheque bootboox-container tab-cheque-payment">

					<h4 ng-show="pmethodId" class="text-center title hidden"><?php echo trans('text_pmethod'); ?>: <b>{{ pmethodName }}</b></h4>

					<div class="btn-toolbar hidden" role="toolbar" aria-label="...">
					...
					<div class="btn-toolbar mb-10 hidden" role="toolbar" aria-label="...">
						<div class="btn-group btn-group-justified" role="group" aria-label="...">
							<div class="btn-group" role="group">
					...
					<div class="table-responsive">
						<table class="table table-bordered table-striped table-condensed">
							...
							<tfoot>
								<tr class="bg-blue">
									<th class="text-right w-50" colspan="6">
										<h4><b>
											<?php echo trans('text_total_amount'); ?></b></h2>
										<small>({{ totalItem }} items)</small>
									</th>
									<input type="hidden" name="payable-amount" value="{{ totalPayable }}">
									<td>
										<h2 class="text-center"><b>{{ totalPayable | formatDecimal:2 }}</b></h4>
									</td>
								</tr>
								<tr>
									<th class="text-right w-50" colspan="6">
										<h4><b>
											<?php echo trans('text_pay_amount'); ?></b></h2>
									</th>
									<td class="text-right w-40 hidden">{{ paidAmount | formatDecimal:2 }}</td>
									<td>
										<h2 class="text-center"><b> <input id="paid-amount" class="form-control" style="font-size: 24px;" type="text" name="paid-amount" ng-model="paidAmount" placeholder="<?php echo trans('placeholder_input_an_amount'); ?>" ng-keypress="checkoutWhilePressEnter($event)" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" onKeyUp="if(this.value<0){this.value='1';}"> </b></h4>
									</td>
								</tr>
								<tr class="bg-yellow">
									<th class="text-right w-50" colspan="6">
										<h4><b>
											<?php echo trans('text_total_balance'); ?></b></h2>
									</th>
									<td>
										<h2 class="text-center"><b>{{ totalPayable < paidAmount ? paidAmount - totalPayable  : 0 | formatDecimal:2 }}</b></h4>
									</td>
								</tr>
							</tfoot>
						</table>
					...
					<div class="btn-toolbar" role="toolbar" aria-label="...">
						<div class="btn-group btn-group-justified" role="group" aria-label="...">
							<div class="btn-group" role="group">
								<a ng-click="checkout()" onClick="return false;" class="btn btn-success btn-md full-paid">
									<span class="fa fa-fw fa-money"></span> COBRAR
								</a>
							</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-4 order-details bootboox-container hidden">

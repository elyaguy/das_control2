<div id="action-button" class="row">
  <?php if (user_group_id() == 1 || has_permission('access', 'create_sell_invoice')) : ?>
    ...
    <?php if (user_group_id() == 1 || has_permission('access', 'read_purchase_all_report')) : ?>
      <div class="col-xs-6 col-sm-4 col-md-4 col-lg-2" id="button_purchase_all_report">
          <div class="panel panel-app">
            <div class="panel-body">
              <a class="panel-app-link" href="report_purchase_itemwise_all.php">
                <h2>
                  <span class="icon">
                    <svg class="svg-icon"><use href="#icon-btn-purchase-all-report"></svg>
                  </span>
                </h2>
                <div class="small small2">
                  <?php echo trans('button_purchase_all_report'); ?>
                </div>
              </a>
            </div>
          </div>

...
<form class="form-horizontal" id="box-form" action="box.php" method="post">
  ...
  <div class="box-body">
    ...
    <!-- <div class="form-group">
      ...
      <div class="col-sm-8 store-selector">
        <div class="checkbox selector">
          <label>
            <input type="checkbox" onclick="$('input[name*=\'box_store\']').prop('checked', this.checked);"> Seleccionar / Deseleccionar
          </label>
        </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">            
        <button id="box-update" class="btn btn-info"  data-form="#box-form" data-datatable="#box-box-list" name="btn_edit_loan" data-loading-text="Actualizando Espera..!">

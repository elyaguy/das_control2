		...
		<div class="table-responsive">
			<table class="table table-bordered table-striped table-condensed">
				<tbody>
					...
					<tr>
						<td class="w-30 bg-gray text-right hidden">
							<?php echo trans('label_gtin'); ?>
						</td>
						<td class="w-70 hidden">
			...
			<div class="table-responsive">
				<table class="table table-bordered margin-b0 table-condensed">
					<thead>
						<tr class="bg-gray">
							<th class="w-80"><?php echo trans('label_product'); ?></th>
					...
					<tbody>
						...
						foreach ($invoice_items as $product) : ?>
							<tr>
								...
								<td class="text-right">
									<?php echo $product['unitName']; ?>
								</td>
								<td class="text-right">
									<?php echo currency_format($product['item_quantity']); ?>
								</td>
								<!-- <td class="text-right">
								...
								<td class="text-right">
									<?php
									$subtotal += $product['item_quantity'];
									echo currency_format($product['item_quantity']); ?>
								</td> -->
							</tr>
						<?php endforeach; ?>
					</tbody>
			...
			<?php if (!empty($payments)) : ?>
				...
				<div class="table-responsive">
					<table class="table table-bordered margin-b0 table-condensed">
						<thead>
							<tr class="bg-gray">
								<th class="w-100 text-center"><?php echo trans('label_description'); ?></th>
						...
						<tbody>
							...
							?>
								<tr class="bt-1 <?php echo $color; ?>">
									...
									<td class="w-25 text-right hidden">
										<?php if ($row['type'] == 'return') : ?>

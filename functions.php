...
$Hooks->do_action('After_Create_Course', $brand);
$Hooks->do_action('Before_Update_Course', $request);
$Hooks->do_action('After_Update_Course', $brand);
$Hooks->do_action('Before_Delete_Course', $request);
$Hooks->do_action('After_Delete_Course', $brand);
$Hooks->do_action('Before_Course_Create_Form');
$Hooks->do_action('After_Course_Create_Form');
$Hooks->do_action('Before_Course_Edit_Form', $brand);
$Hooks->do_action('After_Course_Edit_Form', $brand);
